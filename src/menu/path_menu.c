...
int set_path_menu_settings(menu_t *menu, btn_t *btn, game_t *game)
{
    ...
    ("ressources/menu/down_btn.png", &btn->down_btn.texture, 1, 1);
    btn->up_btn.sprite = init_sprite
    ("ressources/menu/up_btn.png", &btn->up_btn.texture, 1, 1);
    menu->sign_settings.sprite = init_sprite
    ("ressources/menu/sign_settings.png",
    &menu->sign_settings.texture, 1, 1);
    set_path_btn(btn);
...
int set_path_menu(menu_t *menu, btn_t *btn, game_t *game)
{
    ...
    menu->rules.sprite = init_sprite
    ("ressources/menu/about_btn.png", &menu->rules.texture, 0.5, 0.5);
    ...
    ("ressources/menu/restart_btn.png", &btn->wood_btn[6].texture, 1, 1);
