...
int initialize_pnj(game_t *game)
{
    ...
    init_pnj(game, 3, "ressources/pnj/path/path_pnj_four.txt", 34);
    init_script(game, 3, 136);
    init_pnj(game, 4, "ressources/pnj/path/path_pnj_five.txt", 31);
    init_script(game, 4, 93);
    init_pnj(game, 5, "ressources/pnj/path/path_pnj_six.txt", 31);
    init_script(game, 5, 93);
    init_pnj(game, 6, "ressources/pnj/path/path_pnj_seven.txt", 32);
    init_script(game, 6, 96);
    init_pnj(game, 7, "ressources/pnj/path/path_pnj_eight.txt", 34);
    init_script(game, 7, 102);
    init_pnj(game, 8, "ressources/pnj/path/path_pnj_nine.txt", 33);
    ...
    init_pnj(game, 11, "ressources/pnj/path/path_pnj_twelve.txt", 49);
